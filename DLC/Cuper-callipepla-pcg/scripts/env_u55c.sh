...
export CUPER_CALLIPEPLA_HBM_CHANNELS="${CUPER_CALLIPEPLA_HBM_CHANNELS:-16}"
export CUPER_CALLIPEPLA_SPMV_STRIP_PADDING="${CUPER_CALLIPEPLA_SPMV_STRIP_PADDING:-1}"
export CUPER_CALLIPEPLA_SPMV_ACC_WINDOW="${CUPER_CALLIPEPLA_SPMV_ACC_WINDOW:-10}"
export CUPER_CALLIPEPLA_TRACE_LIGHT="${CUPER_CALLIPEPLA_TRACE_LIGHT:-0}"
export CUPER_CALLIPEPLA_PROBE_MODE="${CUPER_CALLIPEPLA_PROBE_MODE:-}"
export CUPER_CALLIPEPLA_LOADER_DRAIN_LEVEL="${CUPER_CALLIPEPLA_LOADER_DRAIN_LEVEL:-1}"
