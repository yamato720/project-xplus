...
split-bank m_axi 写回和 BO sync 边界；当前已板测通过的 demo 是
`JACOBI_TRACE_LIGHT=1` 的完整 `CuperJacobiIteration` master-controller full graph
debug 版。该版把 DATA clock 降到 150 MHz，routed timing 已收敛，并已完成
