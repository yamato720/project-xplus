...
DEFAULT_DATA_ROOT = ROOT / "data" / "suitesparse"
...
DATASETS = {
    ...
    "thermal2_n1024": DatasetSpec(
        ...
        b_source="A * deterministic smooth x_ref",
        subset_n=1024,
        description="Leading 1024x1024 principal submatrix for current kMaxN bitstream smoke tests.",
    ),
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download SuiteSparse matrices and convert them to Project-XPlus CSR text datasets."
    )
    parser.add_argument(
        "--datasets",
        nargs="*",
