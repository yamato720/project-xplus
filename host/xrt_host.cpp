...
void write_text_report(const std::filesystem::path& path,
...
void write_json_report(const std::filesystem::path& path,
    ...
    output << "{\n";
    output << "  \"dataset\": {\n";
    output << "    \"path\": \"" << json_escape(options.dataset_dir.string()) << "\",\n";
    output << "    \"xclbin\": \"" << json_escape(options.xclbin_path.string()) << "\",\n";
    output << "    \"n\": " << dataset.n() << ",\n";
